...
class UnmatchedForumHotelTable(Base) :
    ...
    __tablename__ = 'unmatched_forum_hotel_table2'

    uid = Column(Integer, Sequence('unmatched_forum_hotel_sequence'), primary_key=True)
    forum_hotel_id = Column(Integer, ForeignKey('processed_raw_forum_data5.uid')) #   record id for the processed forum raw data
