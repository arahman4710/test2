...
class MatchedForumHotel2(Base) :

    __tablename__ = 'matched_forum_hotel_table2'

    uid = Column(Integer, primary_key=True)
    forum_hotel_id = Column(Integer())  #   id of the processed forum hotel table, that was matched
