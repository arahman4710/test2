...
def process_page(browser, exec, cur_city)
	...
	matches.each_with_index do |match, index|
		...
		#
			...
			if (region and regionid and lat and lng and points) then
				...
				File.open("output/pl.citytoregion", "a") { |f| f.write("#{cur_city} HAS #{region}\n") }
	...
	File.open("output/process.txt", "a") { |file| file.write("#{output}\n") }
...
exec = Watir::Browser.new :chrome
exec.goto("http://www.writecodeonline.com/javascript/")
browser.goto "http://travela.priceline.com/hotels/?plf=pcln"
