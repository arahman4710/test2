...
class Connection(object):
	...
	def build_request_headers(self):
		...
		return { 'Authorization' : 'Basic ' + auth, 'Accept' : 'application/json', 'Last-Modified-Since' : 'Thu, 29 Mar 2012 00:00:00 GMT' }
...
class Orders(Resource):
	...
	def get_shipping_address(self, id):
                shipping_address = self.client.request_json('GET', '/orders/' + str(id) + '/shippingaddresses')
                return shipping_address
        
        @classmethod
        def get_products_info(self, id):
        	products = self.client.request_json('GET', '/orders/' + str(id) + '/products')
        	return products
        @classmethod
        def get_shipments_info(self, id):
        	shipments = self.client.request_json('GET', '/orders/' +str(id) + '/shipments')
        	return shipments
