...
class PricelineRegionTable(Base) :
    ...
    name =  Column(String())  #   name of the priceline region
    latitude = Column(Decimal())    #   latitude of the center of the region
    longitude = Column(Decimal())    #   longitude of the center of the region
    active = Column(Integer())  #   Determines whether the region is active or not
    star_availability = Column(String())    # this is a bitstring representing the presence of hotel with a specific star the bitstring is formatted as follows ( 5 4.5 4 3.5 3 2.5 2 1 => 4.5 being resorts )
